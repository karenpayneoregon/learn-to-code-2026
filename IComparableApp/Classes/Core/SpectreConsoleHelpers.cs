...
namespace IComparableApp.Classes.Core;
public static class SpectreConsoleHelpers
{
    ...
    /// <summary>
    /// Prints the name of the calling method in hot pink color to the console.
    /// </summary>
    /// <param name="methodName">
    /// The name of the calling method. This parameter is automatically populated
    /// with the caller's method name if not explicitly provided.
    /// </param>
    /// <remarks>
    /// The method formats the method name by splitting camel case words and 
    /// displays it using Spectre.Console markup with a "hotpink2" style.
    /// </remarks>
    public static void PrintPinkSimple([CallerMemberName] string? methodName = null)
    {
        AnsiConsole.MarkupLine($"[hotpink2]{methodName.SplitCamelCase()}[/]");
        Console.WriteLine();
    }
